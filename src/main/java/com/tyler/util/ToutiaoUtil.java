...
public class ToutiaoUtil {
    ...
    public static String UPLOAD_DIR = "d:\\upload\\";
    public static String QINIU_IMAGE_DOMAIN = "http://onv71m8v0.bkt.clouddn.com/";
    private static String[] IMAGE_EXT = new String[]{"png","bmp","jpg","jpeg","gif"};
